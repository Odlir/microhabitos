...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Email – Effectus Fischman</title>
    ...
    <body bgcolor="#34495E" style="margin: 0; padding: 0;" yahoo="fix">
        ...
        <table align="center" border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse; width: 100%; max-width: 600px;" class="content">
            ...
            <tr>
                <td align="center" bgcolor="#00006B"  style="padding: 20px 20px 20px 20px; color: #ffffff; font-family: Arial, sans-serif; font-size: 36px; font-weight: bold;">
            ...
            <tr>
                <td align="center" bgcolor="#ffffff" style="padding: 40px 20px 40px 20px; color: #555555; font-family: Arial, sans-serif; font-size: 20px; line-height: 30px; border-bottom: 1px solid #f6f6f6;">
                    <b>Estimado/a: <?php echo $nombre; ?></b>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td align="center" bgcolor="#f9f9f9" style="padding: 30px 20px 30px 20px; font-family: Arial, sans-serif; border-bottom: 1px solid #f6f6f6;">
                    <table bgcolor="#00006B" border="0" cellspacing="0" cellpadding="0" class="buttonwrapper">
                        <tr>
                            <td align="center" height="50" style=" padding: 0 25px 0 25px; font-family: Arial, sans-serif; font-size: 16px; font-weight: bold;" class="button">
                                <a href="<?=site_url('formulario/index')?>/<?php echo $codigo; ?>" style="color: #ffffff; text-align: center; text-decoration: none;">Ver</a>
                            </td>
                        </tr>
                    </table>
                </td>
