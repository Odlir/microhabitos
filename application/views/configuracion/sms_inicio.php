		...
		<div class="card">
			...
			<div class="card-block">
                <div class="row">
                    <div class="col-sm-12">
                        <form id="frmMensaje">
                            <input type="hidden" id="urlMensajeForm" value="<?=site_url('ConfiguracionSMS/sms_create')?>">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <textarea rows="5" cols="5" class="form-control" name="textoMensaje" id="textoMensaje" placeholder="Ingresar mensaje de notificación en el sms"><?php echo $data->codigo_maestro_descripcion;?></textarea>
                                </div>
                            </div>
                        </form>
                    </div>
